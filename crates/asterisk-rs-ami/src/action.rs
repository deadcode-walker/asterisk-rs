...
mod tests {
    ...
    fn status_action_with_channel() {
        ...
        assert!(headers
            .iter()
            .any(|(k, v)| k == "Channel" && v == "PJSIP/100-0001"));
    }
    ...
    fn queue_add_action_builder() {
        ...
        assert!(headers
            .iter()
            .any(|(k, v)| k == "Interface" && v == "PJSIP/100"));
        assert!(headers.iter().any(|(k, v)| k == "Penalty" && v == "5"));
        assert!(headers
            .iter()
            .any(|(k, v)| k == "MemberName" && v == "Agent 100"));
    }
    ...
    fn db_get_action() {
        ...
        let headers = action.to_headers();
        assert!(headers.iter().any(|(k, v)| k == "Family" && v == "cidname"));
        assert!(headers
            .iter()
            .any(|(k, v)| k == "Key" && v == "12125551234"));
    }

    #[test]
    fn mix_monitor_action_builder() {
        ...
        assert!(headers
            .iter()
            .any(|(k, v)| k == "File" && v == "/tmp/recording.wav"));
        assert!(headers.iter().any(|(k, v)| k == "Options" && v == "r"));
    }

    #[test]
    fn park_action_builder() {
        ...
        assert!(headers
            .iter()
            .any(|(k, v)| k == "Channel" && v == "PJSIP/100-0001"));
        assert!(headers.iter().any(|(k, v)| k == "Timeout" && v == "30"));
        assert!(headers
            .iter()
            .any(|(k, v)| k == "ParkingLot" && v == "default"));
    }

    #[test]
    fn confbridge_kick_action() {
        ...
        let headers = action.to_headers();
        assert!(headers.iter().any(|(k, v)| k == "Conference" && v == "100"));
        assert!(headers
            .iter()
            .any(|(k, v)| k == "Channel" && v == "PJSIP/200-0001"));
    }

    #[test]
    fn pjsip_show_endpoints_action() {
