...
Run dialplan logic from your Rust service. Answer calls, collect DTMF,
play prompts, query databases, and control call flow with all 47 AGI commands.
...
- All 47 AGI commands with typed async methods
