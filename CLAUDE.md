...
This project is indexed by GitNexus as **asterisk-rs** (3481 symbols, 9703 relationships, 176 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/asterisk-rs/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/asterisk-rs/context` | Codebase overview, check index freshness |
| `gitnexus://repo/asterisk-rs/clusters` | All functional areas |
| `gitnexus://repo/asterisk-rs/processes` | All execution flows |
| `gitnexus://repo/asterisk-rs/process/{name}` | Step-by-step execution trace |
