...
#[test]
fn url_encode_keeps_one_value_inside_one_path_segment() {
    let unreserved = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_.~";
    assert_eq!(url_encode(unreserved), unreserved);
    assert_eq!(
        url_encode("channel/日?name=hello world#part%20"),
        "channel%2F%E6%97%A5%3Fname%3Dhello%20world%23part%2520"
    );
}
...
#[test]
fn config_keeps_special_credentials_out_of_the_public_base_url() {
